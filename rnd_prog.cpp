...
int main( void )
{
  ...
  char window_name[] = "OPENCV LEARNING";
...
int Displaying_Random_Text( Mat image, char* window_name, RNG rng )
{
  ...
  for ( int i = 1; i < NUMBER; i++ )
  {
    ...
    putText( image, "Random Text", org, rng.uniform(0,8),
...
{
  Size textsize = getTextSize("Thank You GOD!", FONT_HERSHEY_COMPLEX, 3, 5, 0);
  ...
  for( int i = 0; i < 255; i += 2 )
  {
    ...
    putText( image2, "Thank You GOD!", org, FONT_HERSHEY_COMPLEX, 3,
